...
async function seedDatabase() {
  try {
    ...
    // Coordenadas fictícias (BASEADAS NA LOCALIZAÇÃO DO USUÁRIO: -15.6606, -56.0362)
    const coordinates = [
      { lat: -15.6606, lng: -56.0362 }, // EXATAMENTE AQUI
      { lat: -15.6616, lng: -56.0372 }, // ~150m
      { lat: -15.6596, lng: -56.0352 }, // ~150m
      { lat: -15.6626, lng: -56.0382 }, // ~300m
      { lat: -15.6586, lng: -56.0342 }, // ~300m
      { lat: -15.6636, lng: -56.0392 }, // ~500m
      { lat: -15.6576, lng: -56.0332 }, // ~500m
      { lat: -15.6646, lng: -56.0402 }, // ~700m
      { lat: -15.6566, lng: -56.0322 }, // ~700m
      { lat: -15.6656, lng: -56.0412 }, // ~900m
    ];
